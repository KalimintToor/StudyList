...
class ScheduleViewController: UIViewController{
    ...
    private var calendarHeightConstraint2: NSLayoutConstraint!
...
extension ScheduleViewController: FSCalendarDataSource, FSCalendarDelegate {
    ...
    func calendar(_ calendar: FSCalendar, boundingRectWillChange bounds: CGRect, animated: Bool) {
        calendarHeightConstraint2.constant = bounds.height
        view.layoutIfNeeded()
    }
...
extension ScheduleViewController {
    func setConstraints(){
        ...
        calendarHeightConstraint2 = NSLayoutConstraint(item: calendar, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 300)
        calendar.addConstraint(calendarHeightConstraint2)
